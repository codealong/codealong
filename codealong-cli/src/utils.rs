...
type CargoError = Error;

// NOTE: this logic is taken directly from Cargo's implementation
...
pub fn with_authentication<T, F>(url: &str, cfg: &git2::Config, mut f: F) -> CargoResult<T>
where
